...
mydb = mysql.connector.connect(
    ...
    user="root",
    password="123456",
    database="DRONE"  # Change to the new database
)
...
def save_image_info(image_path):
    ...
    sql = "INSERT INTO detected (Datetime, image_path) VALUES (%s, %s)"
    val = (timestamp, image_path)
...
url = 'http://192.168.110.91/capture'
